    ...
    render() {
        ...
        return (
            <Box fitAbsolute column>
                ...
                <Box fitAbsolute style={dynamicStyles.mapWrapper} centralize>
                    <MapView
                        style={styles.map}
                        initialRegion={{
                            latitude: 37.78825,
                ...
                <Page noBackground onScroll={this.handleOnScroll} pointerEvents="none">
                    <Animated.View style={dynamicStyles.mapInfoWrapper} pointerEvents="none">
                        <Paper column style={[styles.mapInfo, dynamicStyles.mapInfo]} pointerEvents="none">
                            <Box style={[styles.mapInfoHeader, dynamicStyles.mapInfoHeader]}
                                centralize>
